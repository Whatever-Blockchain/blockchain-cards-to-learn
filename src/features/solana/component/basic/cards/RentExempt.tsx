...
function RentExempt() {
    ...
    async function createNewAccount() {
        ...
        if(rentPubKey != null) {
            ...
            let accountInfo = await connection.getAccountInfo(targetPubKey, 'confirmed');
    ...
    return(
        <div className="featuredItem">
            <span className="featuredTitle">
                Minimal Rent Exempt By Pubkey
            </span>
            <Button style={{float: 'right', marginRight: '0px'}} variant="contained" onClick={createNewAccount}>
                minimal rent exempt
            </Button>
            ...
            <span className="featuredSub">
                <TextField fullWidth size='small' onChange={(e) => handleRentPubKeyChange(e.target.value)}/>
            </span>
        </div>
    )
}
